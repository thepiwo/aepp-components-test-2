...
.ae-slider ::v-deep .agile__slide {
  padding: rem(20px) rem(32px);
}

.ae-slider ::v-deep .agile__dots {
  display: flex;
...
.ae-slider ::v-deep .agile__dots > .agile__dot {
  list-style: none;
  border-radius: 50%;
...
.ae-slider.fullscreen ::v-deep .agile__list,
.ae-slider.fullscreen ::v-deep .agile__track,
.ae-slider.fullscreen ::v-deep .agile__slide {
  height: 100%;
}

.ae-slider.fullscreen ::v-deep .agile__dots {
  position: absolute;
  right: 0;
  left: 0;
  bottom: 0;
